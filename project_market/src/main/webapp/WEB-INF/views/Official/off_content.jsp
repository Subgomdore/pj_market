	...
	<form method=post action="off_write.do">
		<div class="offwirte-contain-pj">
			...
			<div class="offwirte-writer-pj">
				...
				<div class="offwirte-condateprint-pj" style="text-align: left;">
					<fmt:formatDate value="${off.off_date}" pattern="yyyy-MM-dd HH:mm:ss" />
				</div>
			...
			<div class="offwirte-wricontent-pj">
				...
				<div class="offwirte-inputcontent-pj" style="text-align: left; line-height: 30px;">
